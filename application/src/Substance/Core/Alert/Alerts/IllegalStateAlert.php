...
/**
 * An Alert for illegal states.
 */
class IllegalStateAlert extends Alert {

  /**
   * Construct a new illegal state alert.
   *
  ...
  public function __construct( $explanation = '', $code = 0, \Exception $previous = NULL ) {
    parent::__construct( 'Illegal state', $explanation, $code, $previous );
  }

  /**
   * Returns a new illegal state alert.
   *
